...
description: "Summary of REALM (Retrieval-Augmented Language Models) for the Hugging Face reading group"
date: 2020-03-03
categories: [NLP, transformers, retrieval]
image: realm_fig.png
aliases:
  - /2020/03/03/REALM.html
---
...
![Example of text retrieval for a given text input](realm_retrieval_examples.png)
...
![REALM OpenQA Results](realm_results.png)
